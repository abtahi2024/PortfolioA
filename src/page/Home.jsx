...
import profile from "../assets/images/693d5bf2-e244-47da-b90d-36b801b36b00.png"
...
export const Home = () => {
  ...
  const roles = [
    ...
    },
    {
      ...
      desc: "PostgreSql, RESTApi, React, Python",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-12 sm:pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            >
              Full Stack Developer | Django RESTApi
            </p>
            ...
            >
              I'm a passionate{" "}
              <span className="font-semibold">Full Stack Developer</span> in the{" "}
              <span className="font-semibold">Django RESTApi</span>.
            </p>
