...
import freelancer from '../assets/images/Screenshot 2025-11-18 180339.png'
import phimart from '../assets/images/Screenshot 2025-11-23 181756.png'
import clothstore from '../assets/images/Screenshot 2026-05-24 101027.png'
import portfolio from '../assets/images/Screenshot 2026-05-24 103953.png'
  ...
  const projects = [
    {
      ...
      desc: "This is the frontend of the Freelancer Platform — a web application where users can browse services, hire freelancers, and manage their own services.",
      img: freelancer,
      live: "https://freelancer-client-40.vercel.app/",
      git: "https://github.com/abtahi2024/Freelancer-Client_40",
      tech: ["React", "python", "postgreSQL", "Django RESTApi"],
    },
    {
      title: "Phimart",
      desc: "RestMart is a modern, responsive e‑commerce front‑end built with React and designed to pair seamlessly with the Django REST Framework back‑end.",
      img: phimart,
      live: "",
      git: "https://github.com/abtahi2024/E-commerce_phimart",
      tech: ["React", "python", "postgreSQL", "Django RESTApi"],
    },
    {
      title: "ClothStore",
      desc: "This is a Django REST based E-commerce backend project.",
      img: clothstore,
    ...
    },
    {
      ...
      img: portfolio,
      live: "https://morder-portfolio.vercel.app",
      git: "https://github.com/abtahi2024/morderPortfolio",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-4">
        <div className="text-center mb-16">
          ...
          <div className="w-16 h-1 bg-linear-to-r from-blue-500 to-blue-600 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="relative h-56 overflow-hidden bg-linear-to-b from-blue-500/10 to-transparent">
                <img
                  src={project.img}
                  alt={project.title}
