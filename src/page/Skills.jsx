...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Full Stack", level: 85, icon: "📚" },
      { name: "RESTApi", level: 85, icon: "📚" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Django RESTApi", level: 88, icon: "🟢" },
    ],
  },
  {
  ...
  const SkillBar = ({ skill, delay }) => {
    ...
    return (
      <div className="mb-4 group">
        ...
        >
          <div
            className="h-2.5 bg-linear-to-r from-blue-500 to-blue-600 rounded-full transition-all duration-1000 ease-out"
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold bg-linear-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent [text-fill-color:transparent] mb-4 leading-snug overflow-visible pb-1 pt-4">
            My Skills
          </h1>

          <div className="w-24 h-1 bg-linear-to-r from-blue-500 to-blue-600 mx-auto rounded-full mb-6"></div>
