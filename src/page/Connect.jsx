  ...
  const contacts = [
    {
      ...
      label: "Email",
      value: "abtahichowdhury4640@gmail.com",
    },
    {
      icon: <Mail className="w-5 h-5" />,
  ...
  const socials = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/abtahi2024",
    },
    {
      icon: <BsLinkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/abtahi-chowdhury-8994723a2/",
    },
    {
    ...
    <div
      className={`min-h-screen flex items-center justify-center px-6 py-12 pt-24 transition-colors duration-500 ${
        isDark
          ...
          : "bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 text-gray-700"
      }`}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative mb-4">
            <div className="w-32 h-32 rounded-2xl bg-linear-to-br from-blue-500 to-blue-600 p-1">
              <div
              ...
              >
                ...
                <img
                  src="https://aadarsh-portfolio-delta.vercel.app/pro1.jpg"
                  alt=""
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          <a
            href="mailto:abtahichowdhury4640@gmail.com"
