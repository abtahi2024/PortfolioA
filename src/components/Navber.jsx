...
export const Navber = () => {
  ...
  const linkVariants = {
    ...
    visible: (i) => ({
      opacity: 1,
      x: 0,
      transition: { deley: i * 0.05, duration: 0.3 },
    }),
  };
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center px-4 sm:px-6 py-3 sm:py-4 overflow-x-hidden">
        ...
        >
          <NavLink to="/" className="flex items-center gap-2 group">
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold group-hover:shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300">
              J
            </div>
            <span
              className={`text-base sm:text-lg font-bold bg-clip-text bg-linear-to-r from-blue-500 to-blue-700 text-transparent hidden sm:inline group-hover:opacity-80 transition-opacity`}
            >
              Portfolio
            </span>
          </NavLink>
